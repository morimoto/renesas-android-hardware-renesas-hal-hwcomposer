...
#ifndef ANDROID_HARDWARE_GRAPHICS_COMPOSER_PLATFORM_RCAR_H
#define ANDROID_HARDWARE_GRAPHICS_COMPOSER_PLATFORM_RCAR_H
...
#endif // ANDROID_HARDWARE_GRAPHICS_COMPOSER_PLATFORM_RCAR_H
