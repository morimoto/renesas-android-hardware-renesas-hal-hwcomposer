...
#ifndef _RENESAS_OMX_PLUGIN_H_

#define _RENESAS_OMX_PLUGIN_H_

#include <hardware/OMXPluginBase.h>

namespace android {

struct RenesasOMXPlugin : public OMXPluginBase {
    RenesasOMXPlugin();
    virtual ~RenesasOMXPlugin();
...
private:
    ...
    RenesasOMXPlugin(const RenesasOMXPlugin &);
    RenesasOMXPlugin &operator=(const RenesasOMXPlugin &);
};

}  // namespace android

#endif  /* _RENESAS_OMX_PLUGIN_H_ */
