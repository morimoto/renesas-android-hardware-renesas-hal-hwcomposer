...
#ifndef ANDROID_HARDWARE_GRAPHICS_COMPOSER_DRM_PLANE_H
#define ANDROID_HARDWARE_GRAPHICS_COMPOSER_DRM_PLANE_H
...
#endif  // ANDROID_HARDWARE_GRAPHICS_COMPOSER_DRM_PLANE_H
