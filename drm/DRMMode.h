...
#ifndef ANDROID_HARDWARE_GRAPHICS_COMPOSER_DRM_MODE_H
#define ANDROID_HARDWARE_GRAPHICS_COMPOSER_DRM_MODE_H
...
#endif  // ANDROID_HARDWARE_GRAPHICS_COMPOSER_DRM_MODE_H
