...
#ifndef ANDROID_HARDWARE_GRAPHICS_COMPOSER_HWC_DUMP_H
#define ANDROID_HARDWARE_GRAPHICS_COMPOSER_HWC_DUMP_H
...
#endif // ANDROID_HARDWARE_GRAPHICS_COMPOSER_HWC_DUMP_H
