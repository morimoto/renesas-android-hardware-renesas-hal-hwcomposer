...
#ifndef ANDROID_HARDWARE_GRAPHICS_COMPOSER_HWC_BUFFER_H
#define ANDROID_HARDWARE_GRAPHICS_COMPOSER_HWC_BUFFER_H
...
#endif // ANDROID_HARDWARE_GRAPHICS_COMPOSER_HWC_BUFFER_H
