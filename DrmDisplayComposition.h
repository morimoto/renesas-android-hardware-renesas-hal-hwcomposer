...
#ifndef ANDROID_HARDWARE_GRAPHICS_COMPOSER_DRM_DISPLAY_COMPOSITION_H
#define ANDROID_HARDWARE_GRAPHICS_COMPOSER_DRM_DISPLAY_COMPOSITION_H
...
#endif  // ANDROID_HARDWARE_GRAPHICS_COMPOSER_DRM_DISPLAY_COMPOSITION_H
