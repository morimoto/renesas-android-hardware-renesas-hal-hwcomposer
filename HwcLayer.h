...
#ifndef ANDROID_HARDWARE_GRAPHICS_COMPOSER_HWC_LAYER_H
#define ANDROID_HARDWARE_GRAPHICS_COMPOSER_HWC_LAYER_H
...
#endif // ANDROID_HARDWARE_GRAPHICS_COMPOSER_HWC_LAYER_H
